...
function AdminCategoriesPageContent() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-50 overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden p-4 sm:p-8 flex flex-col lg:flex-row gap-4 sm:gap-8">
        {/* Structure Column */}
        <div className={`w-full lg:w-[380px] shrink-0 flex flex-col bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden ${(!showMobileTree && selectedCategory) ? 'hidden lg:flex' : 'flex'}`}>
        ...
        {/* Edit Panel Column */}
        <div className={`flex-1 flex flex-col bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden ${(showMobileTree && selectedCategory) ? 'hidden lg:flex' : 'flex'}`}>
            ...
            <>
              <div className="p-4 sm:p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-lg sm:text-xl font-bold text-slate-900 font-display">Editar Categoría</h2>
                        <p className="text-[10px] text-slate-500 font-medium mt-0.5">ID: #{selectedCategory?.id} • {selectedCategory?.slug}</p>
                    </div>
                </div>
                <div className="flex items-center gap-4">

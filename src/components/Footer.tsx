          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a 
                ...
                aria-label="Facebook de Mundolar Soluciones"
                className="hover:text-primary transition-colors flex items-center justify-center size-10 bg-slate-800 rounded-lg"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Instagram de Mundolar Soluciones"
                className="hover:text-primary transition-colors flex items-center justify-center size-10 bg-slate-800 rounded-lg"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="LinkedIn de Mundolar Soluciones"
                className="hover:text-primary transition-colors flex items-center justify-center size-10 bg-slate-800 rounded-lg"
              >
